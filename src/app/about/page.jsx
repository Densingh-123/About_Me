...
const AboutPage = () => {
      ...
      <div className="h-full overflow-y-scroll  lg:flex " ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64  lg:w-2/3 lg:pr-0 xl:1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            <h1 className="font-bold text-4xl text-purple-700 mb-4 text">
              My Journey
            </h1>
  ...
  >
    {Skills.map((item, index) => (
      <div
        key={index}
        className="rounded p-2 cursor-pointer flex shadow-md hover:shadow-lg "
      >
       <Image
  className="bg-white p-2 transition-transform transform hover:scale-105 w-120 h-120"
